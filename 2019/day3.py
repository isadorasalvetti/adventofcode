    ...
    for w in range(2):
        ...
        for t in wire.split(","):
            ...
            for i in range(movement):
                if direction == "R": position[1] += 1
                if direction == "U": position[0] += 1
                if direction == "L": position[1] += -1
